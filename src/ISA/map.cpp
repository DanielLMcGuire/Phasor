...
const std::unordered_map<OpCode, Phasor::string> opCodeToStringMap = {{OpCode::PUSH_CONST, "PUSH_CONST"},
                                                                   ...
                                                                   {OpCode::MADD, "MADD"},
                                                                   {OpCode::MSUBTRACT, "MSUBTRACT"},
                                                                   {OpCode::MMULTIPLY, "MMULTIPLY"},
                                                                   {OpCode::MDIVIDE, "MDIVIDE"},
                                                                   {OpCode::SQRT, "SQRT"},
                                                                   {OpCode::POW, "POW"},
                                                                   {OpCode::LOG, "LOG"},
                                                                   {OpCode::EXP, "EXP"},
                                                                   ...
                                                                   {OpCode::MADD_R, "MADD_R"},
                                                                   {OpCode::MSUB_R, "MSUB_R"},
                                                                   {OpCode::MMUL_R, "MMUL_R"},
                                                                   {OpCode::MDIV_R, "MDIV_R"},
