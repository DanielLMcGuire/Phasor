...
elseif(CMAKE_CXX_COMPILER_ID MATCHES "GNU|Clang")
    ...
    if(APPLE)
        set(EXE_LINKER_FLAGS    "${LTO_FLAG} -Wl,-dead_strip ${STATIC_FLAG} ${STATIC_LIBS}")
        set(SHARED_LINKER_FLAGS "${LTO_FLAG} -Wl,-dead_strip ${STATIC_LIBS}")
    elseif(WIN32)
        set(EXE_LINKER_FLAGS    "${LTO_FLAG} ${STATIC_FLAG} ${STATIC_LIBS}")
        set(SHARED_LINKER_FLAGS "${LTO_FLAG} ${STATIC_LIBS}")
    else()
        set(EXE_LINKER_FLAGS    "${LTO_FLAG} -Wl,--gc-sections ${STATIC_FLAG} ${STATIC_LIBS}")
        set(SHARED_LINKER_FLAGS "${LTO_FLAG} -Wl,--gc-sections ${STATIC_LIBS}")
    endif()
