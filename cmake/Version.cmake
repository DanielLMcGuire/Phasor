...
if (NOT FORCE_PROJECT_VERSION)
    if(EXISTS "${CMAKE_SOURCE_DIR}/.git")
        ...
        execute_process(COMMAND git rev-parse --short HEAD WORKING_DIRECTORY ${CMAKE_SOURCE_DIR} OUTPUT_VARIABLE RAW_HASH OUTPUT_STRIP_TRAILING_WHITESPACE ERROR_QUIET)
        set(GIT_COMMIT_HASH "${RAW_HASH}")
        execute_process(COMMAND git status --porcelain -uno WORKING_DIRECTORY ${CMAKE_SOURCE_DIR} OUTPUT_VARIABLE GIT_STATUS OUTPUT_STRIP_TRAILING_WHITESPACE ERROR_QUIET)
    ...
    if(SHOULD_APPEND_HASH AND NOT GIT_COMMIT_HASH STREQUAL "")
        set(GIT_VERSION_STRING "${GIT_VERSION_STRING}-${GIT_COMMIT_HASH}")
    endif()
else()
    set(GIT_VERSION_STRING "${PROJECT_VERSION}")
endif()